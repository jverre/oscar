...
export default function Home() {
  ...
  const userOrg = useAuthenticatedQuery(api.organizations.getCurrentUserOrg);
  ...
  useEffect(() => {
    ...
    if (user && userOrg && userOrg.subdomain) {
      console.log("Redirecting to user's subdomain:", userOrg.subdomain);
