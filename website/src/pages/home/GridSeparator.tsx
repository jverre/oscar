...
export function GridSeparator({ id = "grid-separator" }: GridSeparatorProps) {
  return (
    <div className="relative">
      <section className="relative h-4 w-full border-b border-sage-green-200">
        {/* Bottom grid circles aligned with boundaries */}
        <div 
          className="absolute z-10 size-2 rounded-full border border-sage-green-200 bg-cream-50 mx-3 md:mx-8 lg:mx-12"
        ...
        <svg className="mx-3 md:mx-8 lg:mx-12 pointer-events-none absolute inset-0 z-0 h-full w-[calc(100%-6rem)] select-none text-sage-green-400 opacity-60">
          <defs>
            <pattern 
